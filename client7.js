...
function init() {
  ...
  scene.background = new THREE.TextureLoader().load( './assets/reflecto.jpeg' );
  ...
  const texture = new THREE.TextureLoader().load( './assets/wine.jpg' );
  ...
  plane.position.set(0 , 60 , -180);
  // Place plane geometry
  scene.add( plane );

  // Second Image (Text with image and white background)
  // Load image as texture
  const texture2 = new THREE.TextureLoader().load( './assets/challenged.jpg' );
  // immediately use the texture for material creation
  const material2 = new THREE.MeshBasicMaterial( { map: texture2, side: THREE.DoubleSide } );
  // Create plane geometry
  const geometry2 = new THREE.PlaneGeometry( 200, 80 );
  // Apply image texture to plane geometry
  const plane2 = new THREE.Mesh( geometry2, material2 );
  // Position plane geometry
  plane2.position.set(-200 , 80 , -400);
  // Place plane geometry
  scene.add( plane2 );

  // Third Image (sunring)
  // Load image as texture
  const texture3 = new THREE.TextureLoader().load( './assets/sunring.jpg' );
  // immediately use the texture for material creation
  const material3 = new THREE.MeshBasicMaterial( { map: texture3, side: THREE.DoubleSide } );
  // Create plane geometry
  const geometry3 = new THREE.PlaneGeometry( 200, 80 );
  // Apply image texture to plane geometry
  const plane3 = new THREE.Mesh( geometry3, material3);
  // Position plane geometry
  plane3.position.set(200 , 80 , -400);
  // Place plane geometry
  scene.add( plane3 );


  //planet shimmer
  const texture4 = new THREE.TextureLoader().load( './assets/reflecto.jpeg' );
  const geometry4 = new THREE.SphereGeometry( 50, 20);
  ...
  scene.add( sphere );
  sphere.position.set(0 , 90 , -400);

  //ring of gorgeous aka hexagon archway
  const texture5 = new THREE.TextureLoader().load( './assets/wine.jpg' );
  const geometry5 = new THREE.TorusGeometry( 150, 20 );
